...
#   82.174.0.214 (Rob thuis)
#   157.97.115.136/29 (Cerios/Valori kantoor)
#   145.131.215.232/29 (Skyliner kantoor, was tot 2026 sysadmin van Valori)
#   2a02:22a0:bbb6:1602::/64 (Skyliner kantoor IPv6)
apt-get -y install ufw
ufw default deny incoming
ufw default allow outgoing
ufw allow from 82.174.0.214 to any port 22
ufw allow from 82.174.0.214 to any port 27017
