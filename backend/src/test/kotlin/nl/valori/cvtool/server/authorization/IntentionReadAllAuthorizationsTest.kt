...
internal object IntentionReadAllAuthorizationsTest {
  ...
  fun testFetchAllAuthorizations() {
    ...
    assertTrue(intentionToTest.match(MONGODB_FETCH_ADDRESS, TestData.messageFetchAllAuthorizations, authInfoTom))
