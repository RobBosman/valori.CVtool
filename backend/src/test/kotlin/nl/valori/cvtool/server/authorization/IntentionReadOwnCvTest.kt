...
internal object IntentionReadOwnCvTest {

  private val intentionToTest = IntentionReadOwnCv
  ...
  fun testGenerateOwnCv() {
    assertTrue(intentionToTest.match(CV_FETCH_ADDRESS, bodyGenerateCvTom, authInfoTom))
  ...
  @Test
  fun testFetchOwnCv() {
    assertFalse(intentionToTest.match(CV_FETCH_ADDRESS, bodyFetchCvTom, authInfoTom))
    assertTrue(intentionToTest.match(MONGODB_FETCH_ADDRESS, bodyFetchCvTom, authInfoTom))
  ...
  fun testFetchOwnCvByAccountId() {
    ...
    assertTrue(intentionToTest.match(MONGODB_FETCH_ADDRESS, bodyFetchCvByAccountIdTom, authInfoTom))
  ...
  fun testFetchOwnSkill() {
    ...
    assertTrue(intentionToTest.match(MONGODB_FETCH_ADDRESS, bodyFetchSkillTom, authInfoTom))
  ...
  fun testFetchOtherCv() {
    assertFalse(intentionToTest.match(CV_FETCH_ADDRESS, bodyFetchCvPascal, authInfoTom))
  ...
  fun testSaveOtherCv() {
    ...
    assertFalse(intentionToTest.match(MONGODB_SAVE_ADDRESS, bodySaveCvPascal, authInfoTom))
  }
  ...
  fun testSaveOtherSkill() {
    ...
    assertFalse(intentionToTest.match(MONGODB_SAVE_ADDRESS, bodySaveSkillPascal, authInfoTom))
  }
