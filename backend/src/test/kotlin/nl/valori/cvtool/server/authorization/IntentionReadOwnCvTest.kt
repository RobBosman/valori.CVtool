...
internal object IntentionReadOwnCvTest {
  ...
  fun testGenerateOwnCv() {
    assertTrue(intentionToTest.match(CV_FETCH_ADDRESS, messageGenerateCvTom, authInfoTom))
  ...
  fun testFetchOwnCv() {
    ...
    assertTrue(intentionToTest.match(MONGODB_FETCH_ADDRESS, messageFetchCvByCvIdTom, authInfoTom))
  ...
  fun testFetchOwnCvByAccountId() {
    ...
    assertTrue(intentionToTest.match(MONGODB_FETCH_ADDRESS, messageFetchCvByAccountIdTom, authInfoTom))
  ...
  fun testFetchOwnSkill() {
    ...
    assertTrue(intentionToTest.match(MONGODB_FETCH_ADDRESS, messageFetchSkillTom, authInfoTom))
