...
import nl.valori.cvtool.server.authorization.TestData.messageFetchAuthInfoTom
...
internal object IntentionReadOwnAuthInfoTest {
  ...
  fun testFetchOwnAuthInfo() {
    assertTrue(intentionToTest.match(AUTH_INFO_FETCH_ADDRESS, messageFetchAuthInfoTom, authInfoTom))
