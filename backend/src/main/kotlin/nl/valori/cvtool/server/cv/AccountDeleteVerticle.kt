...
import nl.valori.cvtool.server.ModelUtils.ACCOUNT_RELATED_ENTITY_NAMES
import nl.valori.cvtool.server.ModelUtils.CV_RELATED_ENTITY_NAMES
...
internal class AccountDeleteVerticle : AbstractVerticle() {
  ...
  override fun start(startPromise: Promise<Void>) {
    vertx.eventBus()
        .consumer<JsonObject>(ACCOUNT_DELETE_ADDRESS)
        .toObservable()
        ...
        .subscribe(
            ...
            {
              log.error("Vertx error in AccountDeleteVerticle")
