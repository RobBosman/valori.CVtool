...
== Docker commands
 ...
 cp -R /var/lib/docker/volumes/root_cvtool_backup/_data/2026-03-22 ~rbosman
 cp -R /var/lib/docker/volumes/root_mongodb_backup/_data/2026-03-22 ~rbosman
 rm -rf ~rbosman/cvtool*.log ~rbosman/2026-03-22
