...
== Docker commands
 ...
 cp -R /var/lib/docker/volumes/root_cvtool_backup/_data/2025-10-09 ~rbosman
 cp -R /var/lib/docker/volumes/root_mongodb_backup/_data/2025-10-09 ~rbosman
 rm -rf ~rbosman/2025-10-09
