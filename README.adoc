...
React + Redux + Kotlin + vert.x + MongoDB + Docker application to edit and maintain curriculum vitae, see https://cvtool.cerios.nl/[cvtool.valori.nl].
...
== Docker commands
 ...
 cp -R /var/lib/docker/volumes/root_cvtool_backup/_data/2025-12-27 ~rbosman
 cp -R /var/lib/docker/volumes/root_mongodb_backup/_data/2025-12-27 ~rbosman
 rm -rf ~rbosman/2025-12-27
