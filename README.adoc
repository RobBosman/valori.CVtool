...
== Docker commands
 ...
 cp -R /var/lib/docker/volumes/root_cvtool_backup/_data/2024-05-28 ~rbosman
 cp -R /var/lib/docker/volumes/root_mongodb_backup/_data/2024-05-28 ~rbosman
 rm -rf ~rbosman/2024-05-28
