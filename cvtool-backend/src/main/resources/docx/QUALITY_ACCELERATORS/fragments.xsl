        ...
        <w:tr w:rsidR="001405E4" w14:paraId="64B68484" w14:textId="5BEC4AB8" w:rsidTr="000A0E47">
            ...
            <w:tc>
                <w:tcPr>
                    ...
                    <w:tcBorders>
                        <w:bottom w:val="{$bottomLineStyle}" w:sz="4" w:space="0" w:color="624D92"/>
                    </w:tcBorders>
        ...
        <w:tr w:rsidR="001405E4" w14:paraId="4FC5C810" w14:textId="7D0C3EB0" w:rsidTr="001405E4">
            ...
            <w:tc>
                <w:tcPr>
                    ...
                    <w:tcBorders>
                        <w:end w:val="single" w:sz="4" w:space="0" w:color="624D92"/>
                        <w:bottom w:val="{$bottomLineStyle}" w:sz="4" w:space="0" w:color="624D92"/>
                    </w:tcBorders>
                    <w:vAlign w:val="center"/>
                </w:tcPr>
            ...
            <w:tc>
                <w:tcPr>
                    ...
                    <w:tcBorders>
                        <w:start w:val="single" w:sz="4" w:space="0" w:color="624D92"/>
                        <w:bottom w:val="{$bottomLineStyle}" w:sz="4" w:space="0" w:color="624D92"/>
                    </w:tcBorders>
                    <w:vAlign w:val="center"/>
                </w:tcPr>
