            ...
            <w:body>
                        ...
                        <w:r w:rsidRPr="00D55949">
                            <w:t>
                                <xsl:call-template name="translate">
                                    <xsl:with-param name="text" select="'Profielschets'"/>
                                </xsl:call-template>
                            </w:t>
                        </w:r>
                    </w:p>
                ...
                <w:p w14:paraId="6DD8B0DA" w14:textId="3ABD36DD" w:rsidR="00475635" w:rsidRDefault="00BF29B7"
                    ...
                    <w:r>
                        <w:t>
                            <xsl:call-template name="translate">
                                <xsl:with-param name="text" select="'Kennis &amp; vaardigheden'"/>
                            </xsl:call-template>
                        </w:t>
                    </w:r>
                </w:p>
                        ...
                        <w:tc>
                            ...
                            <w:p w14:paraId="1B8FA0EB" w14:textId="06FE1258" w:rsidR="00F15DA6"
                                ...
                                <w:r>
                                    <w:t>
                                        <xsl:call-template name="translate">
                                            <xsl:with-param name="text" select="'Rol'"/>
                                        </xsl:call-template>
                                    </w:t>
                                </w:r>
                            </w:p>
                ...
                <xsl:if test="$educations">
                    <w:p w14:paraId="6C209D83" w14:textId="48D9D99D" w:rsidR="001860B4" w:rsidRDefault="001860B4"
                        ...
                        <w:r>
                            <w:t>
                                <xsl:call-template name="translate">
                                    <xsl:with-param name="text" select="'Opleidingen'"/>
                                </xsl:call-template>
                            </w:t>
                        </w:r>
                    </w:p>
                            ...
                            <w:tc>
                                ...
                                <w:p w14:paraId="47102961" w14:textId="549871FC" w:rsidR="001860B4"
                                    ...
                                    <w:r>
                                        <w:t>
                                            <xsl:call-template name="translate">
                                                <xsl:with-param name="text" select="'Training'"/>
                                            </xsl:call-template>
                                        </w:t>
                                    </w:r>
                                </w:p>
                            ...
                            <w:tc>
                                ...
                                <w:p w14:paraId="3E786C01" w14:textId="6055BD31" w:rsidR="001860B4"
                                    ...
                                    <w:r>
                                        <w:t>
                                            <xsl:call-template name="translate">
                                                <xsl:with-param name="text" select="'Media'"/>
                                            </xsl:call-template>
                                        </w:t>
                                    </w:r>
                                </w:p>
                            ...
                            <w:tc>
                                ...
                                <w:p w14:paraId="0B2114F9" w14:textId="30FD0186" w:rsidR="001860B4"
                                    ...
                                    <w:r>
                                        <w:t>
                                            <xsl:call-template name="translate">
                                                <xsl:with-param name="text" select="'Jaar'"/>
                                            </xsl:call-template>
                                        </w:t>
                                    </w:r>
                                </w:p>
                            ...
                            <w:tc>
                                ...
                                <w:p w14:paraId="2CD43EAD" w14:textId="13C86D98" w:rsidR="001860B4"
                                    ...
                                    <w:r>
                                        <w:t>
                                            <xsl:call-template name="translate">
                                                <xsl:with-param name="text" select="'Omschrijving'"/>
                                            </xsl:call-template>
                                        </w:t>
                                    </w:r>
                                </w:p>
                ...
                <xsl:if test="$interests">
                    <w:p w14:paraId="1227FA0A" w14:textId="1961BDE8" w:rsidR="001860B4" w:rsidRDefault="001860B4"
                        ...
                        <w:r>
                            <w:t>
                                <xsl:call-template name="translate">
                                    <xsl:with-param name="text" select="'Interesses'"/>
                                </xsl:call-template>
                            </w:t>
                        </w:r>
                    </w:p>
