    ...
    <xsl:template name="translate">
        ...
        <xsl:choose>
            <xsl:when test="$cv_locale = 'uk_UK'">
                <xsl:choose>
                    <xsl:when test="$text = 'afgebroken'">cancelled</xsl:when>
                    ...
                    <xsl:when test="$text = 'Curriculum vitae van'">Curriculum vitae of</xsl:when>
                    ...
                    <xsl:when test="$text = 'Jaar'">Year</xsl:when>
                    <xsl:when test="$text = 'Kennis &amp; vaardigheden'">Knowledge &amp; skills</xsl:when>
                    <xsl:when test="$text = 'Kerncompetenties / skills'">Knowledge / skills</xsl:when>
                    <xsl:when test="$text = 'Media'">Media</xsl:when>
                    ...
                    <xsl:when test="$text = 'Omschrijving'">Description</xsl:when>
                    ...
                    <xsl:when test="$text = 'Profielschets'">Profile</xsl:when>
                    ...
                    <xsl:when test="$text = 'Referenties'">References</xsl:when>
                    <xsl:when test="$text = 'Resultaat'">Results</xsl:when>
                    <xsl:when test="$text = 'Resultaten'">Results</xsl:when>
                    <xsl:when test="$text = 'Rol'">Role</xsl:when>
