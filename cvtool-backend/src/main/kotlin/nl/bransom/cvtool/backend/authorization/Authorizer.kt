...
import nl.bransom.cvtool.backend.authorization.intention.IntentionReadAllBusinessUnits
import nl.bransom.cvtool.backend.authorization.intention.IntentionReadOtherCv
import nl.bransom.cvtool.backend.authorization.intention.IntentionReadOwnAuthInfo
import nl.bransom.cvtool.backend.authorization.intention.IntentionReadOwnCv
import nl.bransom.cvtool.backend.authorization.intention.IntentionUpdateAuthorization
import nl.bransom.cvtool.backend.authorization.intention.IntentionUpdateBrand
import nl.bransom.cvtool.backend.authorization.intention.IntentionUpdateBusinessUnit
import nl.bransom.cvtool.backend.authorization.intention.IntentionUpdateOtherCv
import nl.bransom.cvtool.backend.authorization.intention.IntentionUpdateOwnCv
