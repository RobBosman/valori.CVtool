...
internal class IntentionUpdateOtherCvTest {
    ...
    fun testSearchCvData() {
        ...
        assertFalse(intentionToTest.match(CV_SEARCH_ADDRESS, messageFetchCharacteristicsByAccountIdPascal, authInfoTom))
    ...
    fun testSaveOtherCharacteristics() {
        ...
        assertTrue(intentionToTest.match(MONGODB_SAVE_ADDRESS, messageSaveCharacteristicsPascal, authInfoTom))
    }
