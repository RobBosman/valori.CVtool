...
internal class IntentionReadAllBrandsTest {

    private val intentionToTest = IntentionReadAllBrands
    ...
    fun testFetchAllBrands() {
        ...
        assertTrue(intentionToTest.match(MONGODB_FETCH_ADDRESS, messageFetchAllBrands, authInfoTom))
